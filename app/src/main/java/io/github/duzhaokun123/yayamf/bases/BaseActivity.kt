...
import io.github.duzhaokun123.yayamf.databinding.ActivityBaseRootBinding
import io.github.duzhaokun123.yayamf.utils.TipUtil
import io.github.duzhaokun123.yayamf.utils.maxSystemBarsDisplayCutout
import net.matsudamper.viewbindingutil.ViewBindingUtil

abstract class BaseActivity<BaseBinding : ViewBinding>(
    private val baseBindingClass: Class<BaseBinding>, vararg val configs: Config, @StyleRes val themeId: Int = R.style.Theme_YAYAMF
) : AppCompatActivity() {
    enum class Config {
        NO_TOOL_BAR,
        LAYOUT_NO_TOOL_BAR,
